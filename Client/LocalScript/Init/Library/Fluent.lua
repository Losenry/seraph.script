if shared.Aleonor == "Apocalypse" then
    ...
    return Themes
        ...
        Name = "Seraph",
        Accent = Color3.fromRGB(153, 153, 255),

        Keybind = Color3.fromRGB(153, 153, 255),

        Input = Color3.fromRGB(153, 153, 255),
        InputFocused = Color3.fromRGB(20, 10, 30),
        InputIndicator = Color3.fromRGB(106, 168, 190),

        AcrylicMain = Color3.fromRGB(64, 67, 123),
        AcrylicBorder = Color3.fromRGB(64, 67, 123),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(25, 25, 25), Color3.fromRGB(15, 15, 15)),
        AcrylicNoise = 0.94,
        ...
        Dialog = Color3.fromRGB(64, 67, 123),
        DialogHolder = Color3.fromRGB(81, 84, 139),
        DialogHolderLine = Color3.fromRGB(72, 77, 173),
        DialogButton = Color3.fromRGB(72, 77, 173),
        DialogButtonBorder = Color3.fromRGB(41, 48, 167),
        DialogBorder = Color3.fromRGB(48, 54, 176),
        DialogInput = Color3.fromRGB(146, 149, 209),
        DialogInputLine = Color3.fromRGB(73, 80, 206),
