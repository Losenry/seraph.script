...
-- // Booster;
local BOOST_TABLE = {}
local Players, Lighting, MaterialService, workspace = game:GetService("Players"), game:GetService("Lighting"), game:GetService("MaterialService"), game:GetService('Workspace');

BOOST_TABLE.booster = function()
    task.spawn(function()
        local flagtables = {
            ...
            ["TaskSchedulerRegionPerFrame"] = "false",
            ["EnableFPSUnlocker"] = "true",
            ["DFFlagUserIdPlayerNameCacheLatencyLog"] = "False",
            ["DFIntTaskSchedulerAutoThreadLimit"] = "8",
            ["DFFlagUserIdPlayerNameResolutionTimeoutMs"] = "100",
            ["FFlagNetworkVarReppedAssertEnabled"] = "False",
            ["DFFlagExperimentalRenderPass"] = "True",
            ["FFlagEnableGCapsHardwareTelemetry"] = "False",
            ["FFlagRenderShaderCacheEnabled"] = "True",
            ["FFlagRakNetFixedSimulationFPS"] = "True",
            ["DFIntPhysicsSenderMaxBandwidthBps"] = "100000",
            ["FFlagPhysicsNoGpuOcclusionByDefault"] = "True"
        }
        ...
        local function ApplyFlags()
            ...
            task.spawn(function()
                ...
                local Done_Optimize = nil;
                for flag, value in pairs(flagtables) do
                    pcall(function()
